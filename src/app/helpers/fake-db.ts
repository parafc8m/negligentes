export const DIAS = [
    {
        ...
        descripcion: [
            {
                texto: 'La OMS declara la Emergencia de Salud Pública Internacional por el brote de China',
                media: '2020-01-30-omg.png',
                link: 'https://twitter.com/WHO/status/1222968733829865477'
            }
        ]
    },
    {
    ...
    {
        fecha: new Date('2020-02-23'),
        infectadosItalia: 132,
        muertosItalia: 3,
        infectadosEspana: 2,
        muertosEspana: 1,
        descripcion: [
    ...
    },
    {
        ...
        infectadosItalia: 8514,
        muertosItalia: 631,
        infectadosEspana: 1622,
        muertosEspana: 36,
        descripcion: [
    ...
    {
        fecha: new Date('2020-03-11'),
        infectadosItalia: 10590,
        muertosItalia: 827,
        infectadosEspana: 2002,
        muertosEspana: 50,
        descripcion: [
    ...
    },
    {
        ...
        infectadosItalia: 12839,
        muertosItalia: 827,
        infectadosEspana: 2968,
        muertosEspana: 84,
        descripcion: [
    ...
    },
    {
        ...
        infectadosItalia: 17750,
        muertosItalia: 1441,
        infectadosEspana: 5753,
        muertosEspana: 193,
        descripcion: []
    },
    {
        fecha: new Date('2020-03-15'),
        infectadosItalia: 20603,
        muertosItalia: 1809,
    ...
    },
    {
        ...
        infectadosItalia: 23073,
        muertosItalia: 2158,
        infectadosEspana: 9151,
        muertosEspana: 309,
        descripcion: [
    ...
    {
        fecha: new Date('2020-03-17'),
        infectadosItalia: 26062,
        muertosItalia: 2503,
        infectadosEspana: 11178,
        muertosEspana: 491,
        descripcion: [
    ...
    {
        fecha: new Date('2020-03-18'),
        infectadosItalia: 28710,
        muertosItalia: 2978,
        infectadosEspana: 13716,
        muertosEspana: 598,
        descripcion: [
    ...
    {
        fecha: new Date('2020-03-19'),
        infectadosItalia: 33190,
        muertosItalia: 3405,
        infectadosEspana: 17147,
        muertosEspana: 767,
        descripcion: [
    ...
    {
        fecha: new Date('2020-03-20'),
        infectadosItalia: 47021,
        muertosItalia: 4032,
        infectadosEspana: 19980,
        muertosEspana: 1002,
        descripcion: [
...
export const DATA =  [
...

    {
        ...
        comentario: [
            'Preocupar preocupa, pero estamos en buenas manos',
            'Espana tiene un sistema sanitario fuerte y una red de alerta y detección con expertos profesionales que desde el primer minuto trabajan siguiendo las recomendaciones de la OMS'
        ],
        video: 'jE7_IQLhy60',
        fecha: new Date('2020-02-01')
    },
    ...
    },
    {
        ...
        comentario: [
            'No se entiende muy bien el por qué de esas cancelaciones.  Sólo se puede certificar, con pena, el atolondramiento de algunas de esas grandes empresas.'
        ],
        fecha: new Date('2020-02-25')
    },
    {
